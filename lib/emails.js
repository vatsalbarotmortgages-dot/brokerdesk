    ...
    html: `
      <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;background:#ffffff">
        ...
        <div style="padding:24px 28px;border:1px solid #e2e8f0;border-top:none;border-radius:0 0 12px 12px">
          <p style="font-size:14px;color:#475569;line-height:1.7">This deal has been sitting idle. Consider reaching out to the client or updating the file status.</p>
...
export function fundedFollowupEmail({ clientName, followupNumber, sig }) {
  const messages = {
    1: { subject: `Checking in — ${clientName}`, intro: `It's been about a month since your mortgage funded and I just wanted to check in to see how everything is going with your new home. I hope the move went smoothly and you're settling in well!`, body: `If you have any questions about your mortgage, your payment schedule, or anything else, please don't hesitate to reach out. I'm always here to help.` },
    2: { subject: `Thinking of you — ${clientName}`, intro: `I hope you're enjoying your home! It's been a couple of months since your mortgage funded and I wanted to touch base and see how things are going.`, body: `If you know anyone who is looking to buy a home or renew their mortgage, I'd be grateful for the referral. And of course if there's anything I can help you with, just reach out anytime.` },
    3: { subject: `Your mortgage — 3 month check-in | ${clientName}`, intro: `It's been 3 months since your mortgage funded — congratulations again on your home!`, body: `As time goes on, it's worth keeping an eye on interest rates and your renewal date. I'll be in touch well before your term expires, but if you ever want to review your options, I'm just a call away.` }
  }
